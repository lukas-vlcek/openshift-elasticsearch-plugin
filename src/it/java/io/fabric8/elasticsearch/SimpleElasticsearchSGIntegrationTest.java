...
/**
 * We want exactly one data node in the cluster, no client node.
 */
@ESIntegTestCase.ClusterScope(scope = ESIntegTestCase.Scope.TEST, numDataNodes = 1, numClientNodes = 0)
public class SimpleElasticsearchSGIntegrationTest extends ElasticsearchWithOpenShiftPluginSupport {
